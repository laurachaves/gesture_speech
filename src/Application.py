...
class Application(tk.Frame):
    ...
    def draw_image(self, image_path: str, frame: tk.Frame, canva: tk.Canvas, draw_line: bool = False):
        """
        Draw an image in the given canva, resized to fit the given frame.
    ...
    def reload_images(self):
        ...
        self.draw_image(os.path.join(self.DATA_PATH_ID, self.IMAGE_NAME[2]), self.f0_canva_frame,
                        self.f0_canva)  # TODO add True in the arguments when the right image will be used
    ...
    def create_participant_tree(self, name: str = "name", age: int | str = 8, video_path: str = "./../data/meteo4.mp4",
        ...
        f0_extract("./../data/meteoaudio.mp3",
                   self.DATA_PATH_ID + "f0.csv")  # TODO change the hardcoded path with the audio from the ID folder once it'll be extracted
        plot_pitch("./../data/meteoaudio.mp3",
                   self.DATA_PATH_ID)  # TODO change the hardcoded path with the audio from the ID folder once it'll be extracted
